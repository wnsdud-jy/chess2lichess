# @wnsdud/c2l Release Guide

`@wnsdud/c2l`를 GitHub Release + npm에 배포하는 실전 절차입니다.
...
git status
git add .
git commit -m "feat: package c2l as @wnsdud/c2l with release workflows"
...
- `c2l-v0.1.0-linux-x64`
- `c2l-v0.1.0-linux-arm64`
- `c2l-v0.1.0-darwin-x64`
- `c2l-v0.1.0-darwin-arm64`
- `c2l-v0.1.0-win32-x64.exe`
- `c2l-v0.1.0-checksums.txt`

## 5. npm publish 실행

기본적으로 GitHub Release가 `published` 되면 `npm-publish` 워크플로우가 자동 실행됩니다.

자동 실행이 안 됐으면 Actions 탭에서 `npm-publish`를 `Run workflow`로 수동 실행하고 `tag`에 `v0.1.0` 입력합니다.
